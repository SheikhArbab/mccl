          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/dashboard"
                              className={({ isActive }) =>
                                'group relative capitalize flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            ...
                            >
                              <Translatable text='Form Elements' />
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
              ...
              <li>
                <NavLink
                  to="/Expenses"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('Expenses') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <TbTableShare />
